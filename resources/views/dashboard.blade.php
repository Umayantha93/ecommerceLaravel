...
<form method="post" action="{{url('upload_data')}}" enctype="multipart/form-data">
  ...
  @csrf
        ...
        <input type="text" name="prouduct_name" class="form-control">
        <label class = " form-control">Product Code</label>
        <input type="text" name="prouduct_code" class="form-control">
        ...
        <input type="text" name="category_one" class="form-control">
        <label class = " form-control">Type</label>
        <input type="text" name="category_two" class="form-control">
